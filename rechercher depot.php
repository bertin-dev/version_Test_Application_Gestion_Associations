...
<td width="590" bordercolor="#333333"><div align="center" class="Style4">ETAT DEPOT</div></td>
</table>
...
$req= "SELECT revenu_dm, versement_m, revenu_fm, date FROM compte WHERE matricule= '$mat' AND `type`= 'depot'";
