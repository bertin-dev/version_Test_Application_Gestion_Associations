...
<title>Etat Revenu Global</title>
...
<ul id="MenuBar2" class="MenuBarHorizontal">
  ...
  <li><a href="#" class="MenuBarItemSubmenu Style3"><b><i>Affiche</i></b></a>
      <ul>
        ...
        <li>
          <div align="left"><a href="etat revenu global.html" class="Style5">Etat revenu global</a></div>
        </li>
    </ul>
  </li>
</ul>
...
<table width="263" height="38" border="0" align="center" bgcolor="#CCCCCC">
  <tr>
    <td class="Style3"><div align="center" class="Style2"><em><strong>Etat Revenu Global</strong></em></div></td>
  </tr>
</table>
...
<form method="post" action="etat revenu global.php">
...
//select sur la bdd
$sel= "SELECT  SUM(`revenu_dm`), SUM(`versement_m`), SUM(`revenu_fm`), SUM(`emprunt_m`), SUM( `int_total`), SUM(`amort`) FROM `compte` WHERE `mois`='$mois'";
$exe=mysql_query($sel) or die("ERROR");
$mois=strtoupper($mois);

print "<table align=\"center\" class=\"Style4\">";
 print "\t\t<td align=\"center\" bgcolor=\"#EEEEEE\" class=\"Style4\">ETAT REVENU GLOBAL DU MOIS DE $mois</td>\n";

print "<table align=\"center\" border=1 bgcolor=\"#ffffff\" bordercolor=\"#000000\" width=\"1200\">\n";
print "\t<tr>\n";
             
			 print "\t<th background=\"cofedel/fond.jpg\">SOMME REVENUS DEBUT DU MOIS</th>";
			 print "\t<th background=\"cofedel/fond.jpg\">SOMME VERSEMENTS DU MOIS</th>";
			 print "\t<th background=\"cofedel/fond.jpg\">SOMME REVENUS FIN DU MOIS</th>";
			 print "\t<th background=\"cofedel/fond.jpg\">SOMME EMPRUNTS DU MOIS</th>";
			 print "\t<th background=\"cofedel/fond.jpg\">SOMME INTERETS TOTAL</th>";
			 print "\t<th background=\"cofedel/fond.jpg\">SOMME AMORTISSEMENTS</th>";
			 print "\t</tr>\n";
