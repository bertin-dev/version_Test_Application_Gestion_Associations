...
<title>Etat Remboursement</title>
...
<td width="590" bordercolor="#333333"><div align="center" class="Style4">ETAT REMBOURSEMENT</div></td>
</table>
...
$req= "SELECT int_total, amort, emprunt_fm, date FROM compte WHERE matricule= '$mat' AND `type`='remboursement'";
