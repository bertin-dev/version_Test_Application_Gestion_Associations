...
<table width="239" height="35" border="1" align="center" bordercolor="#CCCCCC" bgcolor="#CCCCCC">
  ...
  <tr>
    <td class="CollapsiblePanelFocused"><div align="center" class="Style5">Facture emprunt</div></td>
  </tr>
</table>
<p>&nbsp;</p>
<form id="form1" name="emprunt" method="post" action="emprunt.php">
<table width="952" height="47" border="0" align="center">
  <tr>
    ...
    <td width="187"><INPUT type=text name="matricule">&nbsp;</td>
    <td width="125" class="Style1"><div align="center" class="Style5">Date</div></td>
    <td width="202"><INPUT name="date" type=text value="<?php
echo date("d-m-Y");

?>" readonly="readonly">&nbsp;</td>
    <td width="113" class="Style1"><div align="center" class="Style5">Numero</div></td>
...
<table width="349" height="211" border="0" align="center">
  <tr>
    <td width="167" height="49" class="Style1"><div align="center" class="Style5">Montant</div></td>
    
    <td width="166"><INPUT type=text name="montant">&nbsp;</td>
  </tr>
  <tr>
